<div class="col-md-3">
    <div class="list-group">
      ...
      <a href="<?php echo site_url('Perpustakaan/index')?>" class="list-group-item"><i class="fa fa-dashboard"></i> Dashboard</a>
      <a href="<?php echo site_url('Perpustakaan/Peminjaman')?>" class="list-group-item"><i class="fa fa-book"></i> Peminjaman</a>
